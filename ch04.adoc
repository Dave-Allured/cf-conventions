...
**`gregorian`** or **`standard`**:: Mixed Gregorian/Julian calendar as defined by Udunits. __This is the default.__  Date/times earlier than 1-1-1 0:0:0 are prohibited.
...
**`julian`**:: Julian calendar.  Date/times earlier than 1-1-1 0:0:0 are prohibited.
